        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              The ultimate AI-powered toolkit for TikTok creators looking to analyze, optimize, and grow their presence.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <a href="#" className="text-gray-400 hover:text-white">
              ...
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64c.27 0 .54.04.79.12V9.4c-.26-.06-.54-.09-.8-.09a5.39 5.39 0 00-5.38 5.38A5.39 5.39 0 009.49 20a5.39 5.39 0 005.38-5.38v-7.3a7.29 7.29 0 004.72 1.73V6.69z"></path>
              </svg>
            </a>
          </div>
        </div>
